...
document.addEventListener('DOMContentLoaded', function() {
  ...
  if (window.location.pathname === '/' || window.location.pathname === '/index.html' || window.location.pathname === '/default.aspx') {
    document.body.classList.add('homepage');
    
    // Inject modern homepage structure
    injectModernHomepage();
  }
...
// ==== MODERN HOMEPAGE INJECTION ====
function injectModernHomepage() {
  // Create modern navigation
  const modernNav = document.createElement('nav');
  ...
  modernNav.innerHTML = `
    ...
    <div class="modern-nav-links">
      <a href="/templates/articlecco_cdo/aid/6716003/jewish/Upcoming-Events.htm" class="modern-nav-link">Events</a>
      <a href="/templates/articlecco_cdo/aid/6164502/jewish/About-Us.htm" class="modern-nav-link">About</a>
      <a href="/library/article_cdo/aid/577994/jewish/Online-Jewish-Resources.htm" class="modern-nav-link">Learning</a>
      <a href="/templates/articlecco_cdo/aid/422780/jewish/Mikvah.htm" class="modern-nav-link">Mikvah</a>
      <a href="/tools/feedback.asp" class="modern-nav-link">Contact</a>
      <a href="/4970020" class="nav-cta">Donate</a>
    </div>
  `;
  ...
  if (header) {
    header.innerHTML = '';
    header.appendChild(modernNav);
  }
  
  // Create modern hero section
  const heroSection = document.createElement('section');
  heroSection.className = 'modern-hero';
  heroSection.innerHTML = `
    <div class="hero-shape hero-shape-1"></div>
    <div class="hero-shape hero-shape-2"></div>
    <div class="modern-hero-content">
      <h1>Welcome to Chabad of New Mexico</h1>
      <p>Your Jewish home in the Southwest. Join our vibrant community for learning, celebration, and connection.</p>
      <div class="hero-buttons">
        <a href="/templates/events.htm" class="hero-btn hero-btn-primary">
          Upcoming Events
          <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
            <path d="M5 12h14m-7-7l7 7-7 7"/>
          </svg>
        </a>
        <a href="/tools/feedback.asp" class="hero-btn hero-btn-secondary">
          Get in Touch
        </a>
      </div>
    </div>
  ...
  featuresSection.className = 'modern-section';
  featuresSection.innerHTML = `
    <div class="section-container">
      <div class="section-header reveal">
        <span class="section-label">What We Offer</span>
        <h2 class="section-title">Enriching Jewish Life in New Mexico</h2>
        <p class="section-subtitle">Discover the many ways to connect, learn, and grow with our community</p>
      </div>
      <div class="features-grid">
        <div class="feature-card reveal">
          <div class="feature-icon">📚</div>
          <h3 class="feature-title">Torah Learning</h3>
          <p class="feature-text">Engage with timeless wisdom through our classes, study groups, and one-on-one learning opportunities.</p>
        </div>
        <div class="feature-card reveal">
          <div class="feature-icon">🕯️</div>
          <h3 class="feature-title">Shabbat & Holidays</h3>
          <p class="feature-text">Experience the warmth of Shabbat dinners and holiday celebrations with our welcoming community.</p>
        </div>
        <div class="feature-card reveal">
          <div class="feature-icon">🤝</div>
          <h3 class="feature-title">Community Programs</h3>
          <p class="feature-text">Connect through social events, volunteer opportunities, and programs for all ages.</p>
        </div>
      </div>
    </div>
  `;
  ...
  cardsSection.className = 'modern-section';
  cardsSection.innerHTML = `
    <div class="section-container">
      <div class="section-header reveal">
        <span class="section-label">Get Involved</span>
        <h2 class="section-title">Join Our Community</h2>
        <p class="section-subtitle">There's always something happening at Chabad</p>
      </div>
      <div class="modern-grid">
        <div class="modern-card reveal">
          <img src="https://w2.chabad.org/media/images/1286/WDIg12860121.jpg" alt="Visitors Guide" class="modern-card-image">
          <div class="modern-card-content">
            <span class="modern-card-label">Visitors</span>
            <h3 class="modern-card-title">Visiting Albuquerque?</h3>
            <p class="modern-card-text">Find kosher food, local attractions, accommodations and everything you need for your stay.</p>
            <a href="/6530799" class="modern-card-link">
        ...
        <div class="modern-card reveal">
          <img src="https://w2.chabad.org/media/images/1254/TjGp12541128.jpg" alt="Renovations" class="modern-card-image">
          <div class="modern-card-content">
            <span class="modern-card-label">Support</span>
            <h3 class="modern-card-title">Building Our Future</h3>
            <p class="modern-card-text">Partner with us in renovating our Mikvah, Sukkah, and facilities to better serve our community.</p>
            <a href="/5148325" class="modern-card-link">
              Learn More
              <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
                <path d="M5 12h14m-7-7l7 7-7 7"/>
              </svg>
        ...
        <div class="modern-card reveal">
          <img src="https://w2.chabad.org/media/images/707/LPNL7075896.jpg" alt="Events" class="modern-card-image">
          <div class="modern-card-content">
            <span class="modern-card-label">Events</span>
            <h3 class="modern-card-title">What's Happening</h3>
            <p class="modern-card-text">Stay connected with our calendar of classes, celebrations, and community gatherings.</p>
            <a href="/templates/events.htm" class="modern-card-link">
              View Calendar
              <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
                <path d="M5 12h14m-7-7l7 7-7 7"/>
              </svg>
  ...
  statsSection.innerHTML = `
    <div class="stats-grid">
      <div class="stat-item reveal">
        ...
        <div class="stat-label">Years Serving NM</div>
      </div>
      <div class="stat-item reveal">
      ...
      <div class="stat-item reveal">
        ...
        <div class="stat-label">Weekly Programs</div>
      </div>
      <div class="stat-item reveal">
        <div class="stat-number">24/7</div>
        <div class="stat-label">Here For You</div>
      </div>
    </div>
  `;
  ...
  ctaSection.innerHTML = `
    <div class="cta-content reveal">
      ...
      <p class="cta-text">Whether you're new to the area or looking to deepen your Jewish journey, we're here to welcome you with open arms.</p>
      <div class="cta-buttons">
        <a href="/tools/subscribe/default.htm" class="hero-btn hero-btn-primary">Join Our Mailing List</a>
        <a href="/tools/feedback.asp" class="hero-btn hero-btn-secondary">Contact Us</a>
      </div>
    </div>
  `;
  
  // Clear existing content and inject new sections
...
// ==== VIDEO HERO (HOMEPAGE ONLY) - DISABLED FOR MODERN DESIGN ====
document.addEventListener('DOMContentLoaded', function() {
  // DISABLED - Using modern design instead
  return;
  
  // Only run on homepage
  if (window.location.pathname !== '/' && window.location.pathname !== '/index.html' && window.location.pathname !== '/default.aspx') return;
